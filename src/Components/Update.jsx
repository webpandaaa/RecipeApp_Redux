...
const Update = () => {
    ...
    return recipe ? (
        <form onSubmit={UpdateHandler} className="w-[70%] m-auto  ">
            <h1 className="text-3xl mt-5 font-extrabold text-orange-600 mb-[5%]">
            ...
            <div className="w-full text-right">
                <button className="rounded-md text-xl bg-orange-600 text-white py-2 px-5 hover:bg-orange-700 duration-200">
                    Re-Publish Recipe &nbsp; &#8594;
                </button>
            </div>
        </form>
    ) : (
        <h1 className="w-full text-center text-4xl text-orange-500 mt-10">
            Loading Recipe...
        </h1>
    );
};
